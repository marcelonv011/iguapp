          ...
          {loadingPubs ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {publications.map((pub) => (
                <Card
                  key={pub.id}
                  className="hover:shadow-xl hover:-translate-y-1 transition-all group overflow-hidden"
                >
                  {pub.images?.[0] && (
                  ...
                  <CardContent className="p-6">
                    {pub.category && (
                      <Badge className="mb-2">{pub.category}</Badge>
                    )}
                    <h3 className="font-bold text-xl mb-2 text-slate-900">
                      {pub.title}
                    </h3>
                    {pub.description && (
                      <p className="text-slate-600 text-sm mb-3 clamp-2">
                        {pub.description}
                      </p>
                    )}
